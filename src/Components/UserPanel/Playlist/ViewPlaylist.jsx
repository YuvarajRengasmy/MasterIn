            ...
            <div className='container-fluid'>
                <div className='row'>
                                                                ...
                                                                <div className='card-lg-body'>
                                                                    {playVideo?.comment?.map((data, index) =>
                                                                        <div className='d-flex align-items-center mt-2' key={index}>
                                                                            <img className='img-fluid rounded-circle' src={data?.user?.image ? data?.user?.image : 'https://s3.ap-south-1.amazonaws.com/pixalive.me/empty_profile.png'} alt="avatar" style={{ width: '2rem', height: '2rem', objectFit: 'cover' }} />
                    ...
                    <div className='col-lg-3 col-12 col-sm-12 col-md-12 mt-lg-5 mx-lg-0 mx-auto fixed-right-content'>
                        {/* List Of Video */}
                        <div className="scroll-bar w-100 mt-5 pb-3" style={{ height: '80vh', overflowY: 'scroll' }}>
                            <div className='mt-2 p-2 sticky-top bg-white fw-bold text-center'>{playList?.name}</div>
                            {playList?.post?.map((data, index) => <div className={`card rounded-2 border border-0 shadow-sm border border-light p-2 pointer mb-3 mt-2  ${playVideo._id === data?._id ? 'video-card' : null}`} onClick={() => handlePlayList(data)}   >
