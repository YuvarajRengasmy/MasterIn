                ...
                <div className="offcanvas offcanvas-start" style={{ width: '15rem' }} data-bs-backdrop="false" data-bs-scroll="true" tabIndex="-1" id="offcanvasLeft" aria-labelledby="offcanvasLeftLabel">
                    ...
                    <div className="offcanvas-body-card mt-3">
                        <div className='d-flex justify-content-center  align-items-center gap-3'>
                            ...
                            <div className='mt-3'>
                                <p className='fw-bolder'>
                                    <a className='text-decoration-none text-dark' href="/ProfilePage">{inputs?.name}</a><br />
                                    <small className='text-secondary fw-lighter'>{inputs?.position ?? null}</small>
                                </p>
                        ...
                        <ul className='fw-bolder mt-2'>
                            ...
                            <li className='list-unstyled p-2'><Link className='text-decoration-none text-dark ' to="/UserNotification" onClick={updateViewNotification}><IoMdNotificationsOutline /> Notification <span className="badge text-bg-danger">{notificationCount}</span></Link></li>
